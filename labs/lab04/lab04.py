...
def reverse_iter(lst):
    ...
    """
    "*** YOUR CODE HERE ***"
    # give one list and return it reversly of every elem index smallest get the biggest 
    # n = 0
    # m = len(lst)-1
    # lstj = []
    # while n <m:
    ...
    for n in range(0, len(lst)):
        lstj = [lst[n]] + lstj
    return lstj
    # idk how much the end of the index 
...
def reverse_recursive(lst):
    ...
    "*** YOUR CODE HERE ***"
        ...
        #     return lst[0]
        # else:    
        #     return  reverse_recursive(lstbackward)
    if len(lst) == 1:
        return lst
    else:
...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    # def make_city(city, x1, y1):
    #     city = sqrt((x1 - x1)**2 + (y1 - y1)**2)
    #     return city
    # return make_city
...
def add_chars(w1, w2):
    ...
    def printhp(s, t):
        if s == t[0]:
            ...
            return printhp(s, t[::1])
    
    if not w1:
        return w2
    else:
        i = len(w2)-printhp(w1, w2)
        return add_chars(w1[1::], w2[:i]+w2[i +1:])

         # compare differences between two Element in strings
    # def printword(word):
    #     if len(word) == 1:
    #         return word
    #     else:
    #         return word(add_chars(w2)[1:]-add_chars(w1)[1:]) 
